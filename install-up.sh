...
#wget -q -O /usr/bin/FILENAME "https://raw.githubusercontent.com/rxtrx/VPNUNLIMITED/update/main/update/FILENAME" && chmod +x /usr/bin/FILENAME
wget -q -O /usr/bin/menu-bot "https://raw.githubusercontent.com/rxtrx/VPNUNLIMITED/update/main/update/menu-bot.sh" && chmod +x /usr/bin/menu-bot

sleep 2
echo -e "$COLOR1│${NC}  $COLOR1[INFO]${NC} Download Changelog File"
wget -q -O /root/changelog.txt "https://raw.githubusercontent.com/rxtrx/VPNUNLIMITED/update/main/update/changelog.txt" && chmod +x /root/changelog.txt
